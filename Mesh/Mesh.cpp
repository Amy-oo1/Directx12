...
#endif // _DEBUG
TSTRING										strShaderFileName = _T("Shader_Mesh.hlsl");
...
UINT										nIndexBufferSize = sizeof(TriangleIndexs);
...
HRESULT Load_D3D12_Index_Buffer() {
	...
	//Vertex Buffer Resource Desc
	{
		...
		stD3D12IndexBufferResourceDesc.Width = nIndexBufferSize;
	...
	//Vertex Buffer View
	{
		...
		stD3D12IndexBufferView.SizeInBytes = nIndexBufferSize;
