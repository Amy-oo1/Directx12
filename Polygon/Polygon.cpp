...
#endif // _DEBUG
TSTRING										strShaderFileName = _T("Shader_Polygon.hlsl");
...
VERTEX TriangleVertices[] = {
		{ { -0.5f,  0.5f, 0.5f }, { 1.0f, 0.0f, 0.0f, 1.0f } },//Left Top
		{ {  0.5f, -0.5f, 0.5f }, { 0.0f, 1.0f, 0.0f, 1.0f } },//Right Bottom
		{ { -0.5f, -0.5f, 0.5f }, { 0.0f, 0.0f, 1.0f, 1.0f } },//Left Bottom
		{ {  0.5f,  0.5f, 0.5f }, { 1.0f, 0.0f, 0.0f, 1.0f } }//Right Top
};
