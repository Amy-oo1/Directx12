...
TSTRING										strImapgeFileName = _T("D:\\cg-api\\leanDirectX12\\texture.jpg");
...
#endif // _DEBUG
TSTRING										strShaderFileName = _T("Shaders8.hlsl");
...
HRESULT Create_D3D12_SRV() {
	...
	//Resource
	{
		...
		stD3D12TextureResourceDesc.Alignment = 0;
...
HRESULT Create_D3D12_Root_Signature() {
	...
	//RootSignature Desc1
	{
		...
		D3D12_ROOT_PARAMETER1 stD3D12RootParameter1 = {};
		{
			...
			stD3D12RootParameter1.DescriptorTable.NumDescriptorRanges = _countof(stD3D12CBVSRVRange1s);
			stD3D12RootParameter1.DescriptorTable.pDescriptorRanges = &stD3D12CBVSRVRange1s[0];
			stD3D12RootParameter1.ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL;
		}
		//Static Sampler Desc
		...
		stRootSignatureDesc1.NumStaticSamplers = 1;
		stRootSignatureDesc1.pStaticSamplers = &stD3D12StaticSamplerDesc;
